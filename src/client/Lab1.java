...
import canvas.ScribbleCanvasListener;
import tool.EraseTool;
...
public class Lab1 extends javax.swing.JFrame
{
    ...
    public EraseTool eraseTool;
    public ScribbleTool scribbleTool;
    public TwoEndsTool twoEndsTool;
	...
	public Lab1 ()
	{
	    ...
	    eraseTool = new EraseTool(canvas);
	    scribbleTool = new ScribbleTool(canvas);
        twoEndsTool = new TwoEndsTool(canvas);
  ...
  protected EventListener makeCanvasListener(ScribbleCanvas canvas) {
	...
	void lineb_actionPerformed(java.awt.event.ActionEvent event) {
	    ...
	    currentTool = twoEndsTool;
        twoEndsTool.setLineShape();
	    System.out.println(twoEndsTool.getCurrentShape());
